...
public class Maze_RB_Astar extends PApplet {
	public static void main(String[] args) {
		PApplet.main(new String[] { "--present", "maze.Maze_RB_Astar" });
	}
		...
		public SteeringOutput getsteering() {
			...
			if(distance<targetRadius){
				if(myCharacter.bot){
					...
					myCharacter.velocity=new PVector(0,0);
					playerPath.findPath(currentNode,NodeAry[Goal],currentNode.nodeNo,NodeAry[Goal].nodeNo);
				}
				return null;
			}
