...
import maze.Maze_RB_Astar.Arrive;
import maze.Maze_RB_Astar.Astar;
import maze.Maze_RB_Astar.Character;
import maze.Maze_RB_Astar.Connection;
import maze.Maze_RB_Astar.Node;
import maze.Maze_RB_Astar.Option;
import processing.core.PApplet;
import processing.core.PImage;
import processing.core.PShape;
import processing.core.PVector;

public class Maze_RB_Djikstra extends PApplet {
	public static void main(String[] args) {
		PApplet.main(new String[] { "--present", "maze.Maze_RB_Djikstra" });
	}
				...
				if(myCharacter.bot){
					...
					if(i%2==0){
						try{
							...
							botPath.findPath(NodeAry[botPath.path.get(pathIndex).nodeNo],currentNode,botPath.path.get(pathIndex).nodeNo,currentNode.nodeNo);
						}catch(Exception e){
