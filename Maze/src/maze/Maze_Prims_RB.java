...
import maze.Maz_Prims_Astar.Connection;
import maze.Maz_Prims_Astar.Node;
...
public class Maze_Prims_RB extends PApplet {
	public static void main(String[] args) {
		PApplet.main(new String[] { "--present", "maze.Maze_Prims_RB" });
	}
...
//				text("Game Over", NodeAry[(int)(row*col/2-row/4)].x, NodeAry[(int)(row*col/2-row/4)].y + size);
				gameOver = true;
			}
		}
		if (reachedGoal()) {
			...
			textAlign(CENTER);
//			textSize(circleSize*3);
//			text("You win", NodeAry[(int)(row*col/2-row/4)].x, NodeAry[(int)(row*col/2-row/4)].y + size);
